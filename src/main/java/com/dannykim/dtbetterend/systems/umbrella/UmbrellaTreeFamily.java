...
final class UmbrellaTreeBranchBlock extends BasicBranchBlock {
    private static final Identifier CLUSTER_ID =
            Identifier.fromNamespaceAndPath("betterend", "umbrella_tree_cluster");
    private static final Identifier MEMBRANE_ID =
            Identifier.fromNamespaceAndPath("betterend", "umbrella_tree_membrane");
